...
var _chatForm = require("./js/chatForm");
var _chatFormDefault = parcelHelpers.interopDefault(_chatForm);
var _listMessage = require("./js/listMessage");
var _mainScss = require("./sass/main.scss");
(0, _listMessage.getListMessage)();
(0, _chatFormDefault.default)(); // const BASE_URL = 'https://test-5e295-default-rtdb.firebaseio.com/';
 // const refs = getRefs();
...
},{"./sass/main.scss":"dFl68","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/chatForm":"8CQ7e","./js/listMessage":"jJXdM"}],"dFl68":[function() {},{}],"gkKU3":[function(require,module,exports) {
...
},{}],"8CQ7e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _apiServices = require("./api-services");
var _data = require("./data");
var _getRefs = require("./get-refs");
var _getRefsDefault = parcelHelpers.interopDefault(_getRefs);
var _listMessage = require("./listMessage");
const refs = (0, _getRefsDefault.default)();
function chatForm() {
    const createNewMessage = (evt)=>{
        evt.preventDefault();
        const message = evt.target.elements.input.value;
        (0, _apiServices.createMessage)({
            message
        }).then((response)=>{
            const messages = {
            ...
            (0, _listMessage.postMessage)(messages);
            (0, _data.messenger).items = [
                ...(0, _data.messenger).items,
                messages
            ];
            console.log("messenger.items", (0, _data.messenger).items);
        });
        refs.form.reset();
    };
...
},{"./api-services":"exSqE","./data":"kq51T","./get-refs":"jW5cQ","./listMessage":"jJXdM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"exSqE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createMessage", ()=>createMessage);
parcelHelpers.export(exports, "getMessage", ()=>getMessage);
parcelHelpers.export(exports, "editMessage", ()=>editMessage);
...
function createMessage(content) {
    try {
        return (0, _axiosDefault.default).post(`${BASE_URL}/messenger.json`, content);
    } catch (error) {
        console.log(error);
    }
}
async function getMessage() {
    try {
        const resault = await (0, _axiosDefault.default).get(`${BASE_URL}/messenger.json`);
...
function editMessage(id, content) {
    (0, _axiosDefault.default).patch(`${BASE_URL}/messenger/${id}.json`, content);
}
function deleteMessage(id) {
    (0, _axiosDefault.default).delete(`${BASE_URL}/messenger/${id}.json`);
}
...
var Buffer = require("2c6338ca87261dd8").Buffer;
"use strict";
/**
...
},{"2c6338ca87261dd8":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("ebc305eb6d144e1e");
var ieee754 = require("77618cf53bd74e38");
...
},{"ebc305eb6d144e1e":"eIiSV","77618cf53bd74e38":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jW5cQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function getRefs() {
    return {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jJXdM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "postMessage", ()=>postMessage);
parcelHelpers.export(exports, "getListMessage", ()=>getListMessage);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _apiServices = require("./api-services");
var _getRefs = require("./get-refs");
...
const deleteItem = (id)=>{
    (0, _data.messenger).items = (0, _data.messenger).items.filter((item)=>item.id !== id);
};
const handleClick = (evt)=>{
    if (evt.target.dataset.action === "delete" || evt.target.nodeName === "IMG") {
        ...
        console.log("id", id);
        deleteItem(id);
        createListItem((0, _data.messenger).items);
        (0, _apiServices.deleteMessage)(id);
    }
    if (evt.target.dataset.action === "edit" || evt.target.nodeName === "IMG") {
        ...
        const messageAds = (0, _data.messenger).items.find((item)=>item.id === id);
        const innerMarkup = `
...
const getListMessage = ()=>{
    (0, _apiServices.getMessage)().then((response)=>{
...
},{"axios":"jo6P5","./api-services":"exSqE","./get-refs":"jW5cQ","./data":"kq51T","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire85c1")
